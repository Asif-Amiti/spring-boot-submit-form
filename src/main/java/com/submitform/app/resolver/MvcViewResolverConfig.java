package com.submitform.app.resolver;
...
@Configuration
@EnableWebMvc
public class MvcViewResolverConfig extends WebMvcConfigurerAdapter{
	/*
	 * @Bean public ViewResolver getViewResolver() { InternalResourceViewResolver
	 * resolver = new InternalResourceViewResolver();
	 * resolver.setPrefix("/templates/jsp/"); resolver.setSuffix(".jsp"); return
	 * resolver; }
	 * 
